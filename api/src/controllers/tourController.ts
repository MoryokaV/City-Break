...
router.post("/insertTour", async (req: Request, res: Response) => {
...
router.put("/editTour", async (req: Request, res: Response) => {
...
router.delete("/deleteTour/:_id", async (req: Request, res: Response) => {
