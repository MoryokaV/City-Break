...
router.post("/insertHotel", async (req: Request, res: Response) => {
...
router.put("/editHotel", async (req: Request, res: Response) => {
...
router.delete("/deleteHotel/:_id", async (req: Request, res: Response) => {
